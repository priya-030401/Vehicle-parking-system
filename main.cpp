...
#define CAR 1
#define SCOOTER 2
/* to store vehicle number, and its row-col position in 
an array */
struct vehicle
{
int num ;
...
int parkinfo[4][10] ; /* a 2-D array to store number of 
vehicle parked */
...
/* get the row
-col position for the vehicle to be parked */
void getfreerowcol ( int type, int *arr ) {
 int r, c, fromrow = 0, torow = 2 ;
 if ( type == SCOOTER )
...
int first( )
{
printf("\n\t\t\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\x
db\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\x
db\xdb\n");
printf("\t\t\xdb \xdb\n");
printf("\t\t\xdb ============================= \xdb\n");
...
PARKING LOT SYSTEM
DEPARTMENT OF ISE, SJCIT 2021-22
 printf ( "\nPress any key to continue..." ) ;
 getch( ) ;
 break ;
case 5 :
